...
<head>
    ...
    <link rel="shortcut icon" href="/dashboard/images/favicon.ico">
        ...
        <!--Swiper slider css-->
        <link href="/dashboard/libs/swiper/swiper-bundle.min.css" rel="stylesheet" type="text/css" />
    ...
    <body data-bs-spy="scroll" data-bs-target="#navbar-example">
            ...
            <nav class="navbar navbar-expand-lg navbar-landing fixed-top job-navbar" id="navbar">
                <div class="container-fluid custom-container">
                    <a class="navbar-brand" href="index.html">
                        <img src="/dashboard/images/logo-dark.png" class="card-logo card-logo-dark" alt="logo dark" height="17">
                        <img src="/dashboard/images/logo-light.png" class="card-logo card-logo-light" alt="logo light" height="17">
                    </a>
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-lg-4">
                            <div class="position-relative home-img text-center mt-5 mt-lg-0">
                                ...
                                <div class="card p-3 rounded shadow-lg application-box">
                                    ...
                                    <div class="avatar-group">
                                        <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Brent Gonzalez">
                                            <div class="avatar-xs">
                                                <img src="/dashboard/images/users/avatar-3.jpg" alt="" class="rounded-circle img-fluid">
                                            </div>
                                        </a>
                                        ...
                                        <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Ellen Smith">
                                            <div class="avatar-xs">
                                                <img src="/dashboard/images/users/avatar-10.jpg" alt="" class="rounded-circle img-fluid">
                                            </div>
                                        </a>
                                        ...
                                        <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Brent Gonzalez">
                                            <div class="avatar-xs">
                                                <img src="/dashboard/images/users/avatar-9.jpg" alt="" class="rounded-circle img-fluid">
                                            </div>
                                        </a>
                                ...
                                <img src="/dashboard/images/job-profile2.png" alt="" class="user-img">
                    ...
                    <div class="row align-items-center justify-content-lg-between justify-content-center gy-4">
                        <div class="col-lg-5 col-sm-7">
                            <div class="about-img-section mb-5 mb-lg-0 text-center">
                                ...
                                <div class="card feedback-box">
                                    <div class="card-body d-flex shadow-lg">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="/dashboard/images/users/avatar-10.jpg" alt="" class="avatar-sm rounded-circle">
                                        </div>
                                ...
                                <img src="/dashboard/images/about.jpg" alt="" class="img-fluid mx-auto rounded-3" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                                    ...
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <div class="avatar-title bg-soft-warning rounded">
                                                <img src="/dashboard/images/companies/img-3.png" alt="" class="avatar-xxs">
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <div class="avatar-title bg-soft-primary rounded">
                                                <img src="/dashboard/images/companies/img-2.png" alt="" class="avatar-xxs">
                                            </div>
                                        </div>
                                        <div class="ms-3 flex-grow-1">
                                            <a href="#!">
                                    ...
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <div class="avatar-title bg-soft-danger rounded">
                                                <img src="/dashboard/images/companies/img-4.png" alt="" class="avatar-xxs">
                                            </div>
                                        </div>
                                        <div class="ms-3 flex-grow-1">
                                            <a href="#!">
                                    ...
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <div class="avatar-title bg-soft-success rounded">
                                                <img src="/dashboard/images/companies/img-9.png" alt="" class="avatar-xxs">
                                            </div>
                                        </div>
                                        <div class="ms-3 flex-grow-1">
                                            <a href="#!">
                                    ...
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <div class="avatar-title bg-soft-info rounded">
                                                <img src="/dashboard/images/companies/img-1.png" alt="" class="avatar-xxs">
                                            </div>
                                        </div>
                                        <div class="ms-3 flex-grow-1">
                                            <a href="#!">
                            ...
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <div class="avatar-title bg-soft-success rounded">
                                                <img src="/dashboard/images/companies/img-7.png" alt="" class="avatar-xxs">
                                            </div>
                                        </div>
                                        <div class="ms-3 flex-grow-1">
                                            <a href="#!">
                            ...
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <div class="avatar-title bg-soft-info rounded">
                                                <img src="/dashboard/images/companies/img-8.png" alt="" class="avatar-xxs">
                                            </div>
                                        </div>
                                        <div class="ms-3 flex-grow-1">
                                            <a href="#!">
                            ...
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <div class="avatar-title bg-soft-warning rounded">
                                                <img src="/dashboard/images/companies/img-5.png" alt="" class="avatar-xxs">
                                            </div>
                                        </div>
                                        <div class="ms-3 flex-grow-1">
                                            <a href="#!">
                                            ...
                                            <a href="javascript: void(0);" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Brent Gonzalez">
                                                <div class="avatar-xs">
                                                    <div class="avatar-title bg-light bg-opacity-25 rounded-circle">
                                                        <img src="/dashboard/images/companies/img-5.png" alt="" height="15">
                                                    </div>
                                                </div>
                                            </a>
                                            <a href="javascript: void(0);" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Brent Gonzalez">
                                                <div class="avatar-xs">
                                                    <div class="avatar-title bg-light bg-opacity-25 rounded-circle">
                                                        <img src="/dashboard/images/companies/img-2.png" alt="" height="15">
                                                    </div>
                                                </div>
                                            </a>
                                            <a href="javascript: void(0);" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Brent Gonzalez">
                                                <div class="avatar-xs">
                                                    <div class="avatar-title bg-light bg-opacity-25 rounded-circle">
                                                        <img src="/dashboard/images/companies/img-8.png" alt="" height="15">
                                                    </div>
                                                </div>
                                            </a>
                                            <a href="javascript: void(0);" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Brent Gonzalez">
                                                <div class="avatar-xs">
                                                    <div class="avatar-title bg-light bg-opacity-25 rounded-circle">
                                                        <img src="/dashboard/images/companies/img-7.png" alt="" height="15">
                                                    </div>
                                                </div>
                                            </a>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="card text-center">
                                            <div class="card-body p-4">
                                                <img src="/dashboard/images/users/avatar-2.jpg" alt="" class="rounded-circle avatar-md mx-auto d-block">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card text-center">
                                            <div class="card-body p-4">
                                                <img src="/dashboard/images/users/avatar-3.jpg" alt="" class="rounded-circle avatar-md mx-auto d-block">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card text-center">
                                            <div class="card-body p-4">
                                                <img src="/dashboard/images/users/avatar-10.jpg" alt="" class="rounded-circle avatar-md mx-auto d-block">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card text-center">
                                            <div class="card-body p-4">
                                                <img src="/dashboard/images/users/avatar-8.jpg" alt="" class="rounded-circle avatar-md mx-auto d-block" />
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card text-center">
                                            <div class="card-body p-4">
                                                <img src="/dashboard/images/users/avatar-5.jpg" alt="" class="rounded-circle avatar-md mx-auto d-block" />
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <img src="/dashboard/images/small/img-8.jpg" alt="" class="img-fluid rounded" />
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <img src="/dashboard/images/small/img-6.jpg" alt="" class="img-fluid rounded" />
                                </div>
                                <div class="card-body">
                                    <ul class="list-inline fs-14 text-muted">
                                        <li class="list-inline-item">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <img src="/dashboard/images/small/img-9.jpg" alt="" class="img-fluid rounded" />
                                </div>
                                <div class="card-body">
                                    <ul class="list-inline fs-14 text-muted">
                                        <li class="list-inline-item">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 mt-4">
                            <div>
                                <div>
                                    <img src="/dashboard/images/logo-light.png" alt="logo light" height="17" />
                                </div>
        ...
        <script src="/dashboard/js/pages/plugins/lord-icon-2.1.0.js"></script>
        ...
        <!--job landing init -->
        <script src="/dashboard/js/pages/job-lading.init.js"></script>
    </body>


<!-- Mirrored from themesbrand.com/velzon/html/default/job-landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Feb 2023 17:32:49 GMT -->
</html>
